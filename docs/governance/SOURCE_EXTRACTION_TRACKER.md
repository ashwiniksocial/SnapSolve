...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| SRC-001 | 6 | Mathematics | Ganita Prakash — Textbook of Mathematics for Grade 6 | NCERT Textbook | First Edition August 2024; Reprint 2026–27 | `fegp1ps`, `fegp101`–`fegp110` (11 PDFs) | COMPLETE | 100% | COMPLETE | NOT STARTED | NOT STARTED | NOT STARTED | NOT STARTED | GM: update `6-Mathematics` gateway EXPECTED map to official Ganita Prakash 10 chapter names when authoring begins | All 10 GP chapter titles extracted; exam-active flags confirmed (all 10 active); alignment vs. legacy 14-chapter NCERT documented. Legacy structure entirely superseded by GP. See `CHAPTER_ALIGNMENT_CLASSES6-9.md` §1 |
| SRC-002 | 6 | Science | Curiosity — Textbook of Science for Grade 6 | NCERT Textbook | First Edition July 2024; Reprint 2026–27 | `fecu1ps`, `fecu101`–`fecu112` (13 PDFs) | COMPLETE | 100% | COMPLETE | NOT STARTED | NOT STARTED | NOT APPLICABLE | NOT STARTED | GM: register `6-Science` in gateway with official 12 Curiosity chapter names when authoring begins | All 12 Curiosity chapter titles extracted; all exam-active (school-based; no Board exam); old 16-chapter legacy superseded. See `CHAPTER_ALIGNMENT_CLASSES6-9.md` §2 |
...
| SRC-004 | 7 | Mathematics | Ganita Prakash — Textbook of Mathematics for Grade 7 (Part I) | NCERT Textbook | Reprint 2026–27 | `gegp1ps`, `gegp101`–`gegp108` (9 PDFs) | COMPLETE | 100% | COMPLETE | NOT STARTED | NOT STARTED | NOT STARTED | NOT STARTED | GM: update `7-Mathematics` gateway EXPECTED map to official GP 15 chapter names when authoring begins | All 8 Part I chapter titles extracted; all exam-active; legacy cbseDeleted Ch10 has no GP counterpart — does not carry forward. See `CHAPTER_ALIGNMENT_CLASSES6-9.md` §3 |
| SRC-005 | 7 | Mathematics | Ganita Prakash — Textbook of Mathematics for Grade 7 (Part II) | NCERT Textbook | Reprint 2026–27 | `gegp2ps`, `gegp201`–`gegp207` (8 PDFs) | COMPLETE | 100% | COMPLETE | NOT STARTED | NOT STARTED | NOT STARTED | NOT STARTED | GM: update `7-Mathematics` gateway EXPECTED map to official GP 15 chapter names; "Constructions and Tilings" is a new active exam chapter — must be authored | All 7 Part II chapter titles extracted; all exam-active; "Constructions and Tilings" is distinct from deleted "Practical Geometry" and requires authoring. See `CHAPTER_ALIGNMENT_CLASSES6-9.md` §3 |
...
| SRC-012 | 9 | Mathematics | Ganita Manjari — Textbook of Mathematics for Grade 9 (Part I) | NCERT Textbook | First Edition April 2026 | 9 PDFs + 1 cover JPG received | IN PROGRESS | 90% | IN PROGRESS | NOT STARTED | NOT STARTED | NOT STARTED | NOT STARTED | Confirm Ch5 "I'm Up and Down, and Round and Round" maps to curriculum Ch5 "Linear Equations in Two Variables" by reading PDF body; once confirmed, CM → COMPLETE | All 8 Part I chapter titles mapped to CBSE 15-chapter curriculum (7 with HIGH confidence; 1 inferred); Part II coverage projected (Ch7–9, 10–11, 13–14); one uncertain mapping flagged. See `CHAPTER_ALIGNMENT_CLASSES6-9.md` §4 |
...
| SRC-014 | 9 | Science | Exploration — Textbook of Science for Grade 9 | NCERT Textbook | First Edition April 2026 | `iesc1ps`, `iesc101`–`iesc113` (14 PDFs) | IN PROGRESS | 90% | IN PROGRESS | IN PROGRESS | IN PROGRESS | NOT STARTED | NOT STARTED | Read PDF title pages (iesc101–iesc113) to confirm exact printed chapter titles; resolve 4 flagged discrepancies (Ch5, Ch11, Ch12, Ch13 short vs. full names) | DEC-007 chapter structure authoritative (14 ch; 12 exam-active; 2 non-exam); 4 chapters may have short DEC-007 names vs. longer textbook titles. See `CHAPTER_ALIGNMENT_CLASSES6-9.md` §5 |
...
|---|---|---|
| COMPLETE | 5 | SRC-001, SRC-002, SRC-004, SRC-005, SRC-021 |
| IN PROGRESS | 2 | SRC-012, SRC-014 |
