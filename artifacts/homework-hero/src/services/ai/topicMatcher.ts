...
const SUBJECT_HINTS: Record<Subject, RegExp[]> = {
  ...
  "Information Technology": [
    /\b(IT|ITeS|BPO|BPM|outsourc|offshoring|ITES|software service|data entry|call centre|helpdesk)\b/i,
    /\b(hardware|software|network|internet|e-business|e-commerce|ergonomic|workstation|health.*safety)\b/i,
  ],
  Science: [
